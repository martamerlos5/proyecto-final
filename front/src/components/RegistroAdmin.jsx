...
function RegistroAdmin() {
  ...
  function procesa(ev) {
    ...
    const url = "http://localhost:8000/api/registro-admin";
      ...
      <section className="registro">
        <div className="registro_contenedor">
          ...
          <form className="form_registro" onSubmit={procesa}>
            ...
            <input type="text" placeholder="Móvil*" required name="movil" />
            ...
            <button className="boton boton_admin">Registrarse</button>
